!function (e) {
  ...
  var s = n(1), i = (r(s), n(2)), o = r(i);
  $("[name=data-range-dynamic]").on("click", function (e) {
    var t = $(e.target), n = t.data();
    if ("tqbDatePicker" in n) {
      var r = new o.default(n.start), s = new o.default(n.end);
      r = r.add("+1d").toString(), s = s.add("1d").toString(), t.data({start: r, end: s})
    }
  })
}, function (e, t, n) {
  (function (t) {
    (function () {
      ...
      function n(e, t) {
        if (this.options = t || u.defaults, this.links = e, this.rules = c.normal, this.renderer = this.options.renderer || new r, this.renderer.options = this.options, !this.links)throw new Error("Tokens array requires a `links` property.");
      ...
      function u(e, n, r) {
        if (r || "function" == typeof n) {
          r || (r = n, n = null), n = h({}, u.defaults, n || {});
          var o, l, a = n.highlight, p = 0;
          try {
            o = t.lex(e, n)
          } catch (e) {
            return r(e)
          ...
          for (; p < o.length; p++)!function (e) {
            "code" !== e.type ? --l || c() : a(e.text, e.lang, function (t, n) {
              return t ? c(t) : null == n || n === e.text ? --l || c() : (e.text = n, e.escaped = !0, void(--l || c()))
            })
          }(o[p])
        } else try {
          return n && (n = h({}, u.defaults, n)), s.parse(t.lex(e, n), n)
        } catch (e) {
          if (e.message += "\nPlease report this to https://github.com/chjj/marked.", (n || u.defaults).silent)return "<p>An error occured:</p><pre>" + i(e.message + "", !0) + "</pre>";
          throw e
        }
      }
      ...
      p.bullet = /(?:[*+-]|\d+\.)/, p.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, p.item = l(p.item, "gm")(/bull/g, p.bullet)(), p.list = l(p.list)(/bull/g, p.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + p.def.source + ")")(), p.blockquote = l(p.blockquote)("def", p.def)(), p._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", p.html = l(p.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, p._tag)(), p.paragraph = l(p.paragraph)("hr", p.hr)("heading", p.heading)("lheading", p.lheading)("blockquote", p.blockquote)("tag", "<" + p._tag)("def", p.def)(), p.normal = h({}, p), p.gfm = h({}, p.normal, {
        ...
        for (var r, s, i, o, l, a, h, u, c, e = e.replace(/^ +$/gm, ""); e;)if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({type: "space"})), i = this.rules.code.exec(e)) e = e.substring(i[0].length), i = i[0].replace(/^ {4}/gm, ""), this.tokens.push({
          type: "code",
          ...
          for (u = 0; u < a.cells.length; u++)a.cells[u] = a.cells[u].split(/ *\| */);
          this.tokens.push(a)
          ...
          for (e = e.substring(i[0].length), o = i[2], this.tokens.push({
            type: "list_start",
            ordered: o.length > 1
          }), i = i[0].match(this.rules.item), r = !1, c = i.length, u = 0; u < c; u++)a = i[u], h = a.length, a = a.replace(/^ *([*+-]|\d+\.) +/, ""), ~a.indexOf("\n ") && (h -= a.length, a = this.options.pedantic ? a.replace(/^ {1,4}/gm, "") : a.replace(new RegExp("^ {1," + h + "}", "gm"), "")), this.options.smartLists && u !== c - 1 && (l = p.bullet.exec(i[u + 1])[0], o === l || o.length > 1 && l.length > 1 || (e = i.slice(u + 1).join("\n") + e, u = c - 1)), s = r || /\n\n(?!\s*$)/.test(a), u !== c - 1 && (r = "\n" === a.charAt(a.length - 1), s || (s = r)), this.tokens.push({type: s ? "loose_item_start" : "list_item_start"}), this.token(a, !1, n), this.tokens.push({type: "list_item_end"});
          ...
          for (u = 0; u < a.cells.length; u++)a.cells[u] = a.cells[u].replace(/^ *\| *| *\| *$/g, "").split(/ *\| */);
          this.tokens.push(a)
      ...
      c._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, c._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, c.link = l(c.link)("inside", c._inside)("href", c._href)(), c.reflink = l(c.reflink)("inside", c._inside)(), c.normal = h({}, c), c.pedantic = h({}, c.normal, {
        ...
        renderer: new r,
        xhtml: !1
      }, u.Parser = s, u.parser = s.parse, u.Renderer = r, u.Lexer = t, u.lexer = t.lex, u.InlineLexer = n, u.inlineLexer = n.output, u.parse = u, e.exports = u
    }).call(function () {
  ...
  var r = function () {
  ...
  }(), s = {m: "Month", d: "Date"}, i = "yyyy-mm-dd", o = function () {
    function e(t) {
      var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
      n(this, e), this.format = r.format || i;
      var s = e.isDate(t, this.format);
      return s ? void(this.base = new Date(s)) : t instanceof Date ? void(this.base = new Date(t)) : (this.base = new Date, this.base.setHours(0), this.base.setMinutes(0), this.base.setSeconds(0), void this.add(t))
    }
    ...
    return r(e, [{
      key: "add", value: function (t) {
        if (t = e.parse(t)) {
          for (var n in t)if (t.hasOwnProperty(n)) {
            var r = s[n];
            this.base["set" + r](this.base["get" + r]() + t[n])
          }
          return this
        }
      }
      ...
      key: "clone", value: function () {
        return new e(this.base, {format: this.format})
      }
    }, {
      ...
      key: "isSameMonth", value: function (e) {
        return this.base.getFullYear() === e.getFullYear() && this.base.getMonth() === e.getMonth()
      }
    }, {
      ...
      key: "toObject", value: function (t, n, r) {
        var s = this.base.getMonth();
        return {
          year: this.base.getFullYear(),
          month: e.toDouble(s + 1),
          empty: this.getFirstDayOfThisMonth(),
          days: e.getDates(this.base, t, n, r, this.format)
        }
      }
    }, {
      key: "toString", value: function () {
        return e.format(this.base, this.format)
      }
    }], [{
      key: "format", value: function (t, n) {
        return n.replace(/y+/gi, function () {
          ...
          return e.toDouble(t.getMonth() + 1)
        }).replace(/d+/gi, function () {
          return e.toDouble(t.getDate())
        })
      }
    }, {
      key: "getDates", value: function (t, n, r, s) {
        var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : i, l = t.getMonth();
        t = new Date(t), t.setDate(1);
        for (var a = []; t.getMonth() === l;) {
          var h = e.format(t, o);
          a.push({
            date: h.substr(0, 10),
            today: n && n.toString() === h,
            disabled: r && h < r.toString() || s && h > s.toString()
          }), t.setDate(t.getDate() + 1)
        }
        return a
      }
    }, {
      key: "isDate", value: function (e, t) {
        t = t || i, e = e.toString();
        var n = [], r = t;
        [/d+/gi, /y+/gi, /m+/gi].forEach(function (e) {
          t = t.replace(e, function (e) {
            return n.push(e.substr(0, 1)), "(\\d{" + e.length + "})"
          })
        });
        var s = new RegExp("^" + t + "$"), o = e.match(s);
        if (!o)return o;
        var l = {};
        return ["y", "m", "d"].forEach(function (t) {
          var n = new RegExp(t + "+", "gi");
          r.replace(n, function (n, r) {
            l[t] = e.substr(r, n.length)
          })
        }), l.y + "-" + l.m + "-" + l.d
      }
    }, {
      ...
      key: "parse", value: function (e) {
        ...
        e = e.toLowerCase();
        var t = {};
        return e.replace(/([+-]?\d+)([ymd])/g, function (e, n, r) {
          t[r] = Number(n)
        }), t
      }
    }, {
      key: "toDouble", value: function (e) {
